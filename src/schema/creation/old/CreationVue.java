...
public class CreationVue extends JPanel {
     ...
     */
    public void addListener(SchemaCreationControleur cl) {
        addMouseListener(cl);
        addKeyListener(cl);
     ...
     * - si l'utilisateur est en mode édition l'élément sera mis sur l'image 
     * aillant le focus<br/>
     * - sinon on passe en mode édition
     * 
     * @param picture image sur laquel le click c'est produit.
     * @return nul ou le code de l'image.
     */
    public Integer clickedOn(Picture picture) {
        Integer i = null;
        ...
        if (picture instanceof PictureCreation) {
            ...
            newPicture = bo.getNewPicture(picture.getCode());
