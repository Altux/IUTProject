...
//        HashMap<Integer, String> sentence = ParametreurModele.loadDescription(SpeakToMe.PATH_PHONETIQUE);
//        SpeakToMe lecteurTexte = new SpeakToMe();
//
//
...
//
//        SchemaControleur controleur = new SchemaControleur(null/*vtp*/, hashBytes, schema, lecteurTexte, sentence, null);
